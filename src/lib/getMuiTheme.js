...
export default function getMuiTheme(muiTheme, ...more) {
  ...
  muiTheme = merge({
    ...
    checkbox: {
      ...
      disabledColor: lighten(NORMAL_CONTROL.color, 0.75),
    ...
    slider: {
      ...
      trackSize: 2,
      trackColor: lighten(NORMAL_CONTROL.color, 0.75),
      trackColorSelected: lighten(NORMAL_CONTROL.color, 0.75),
      handleSize: 12,
      handleSizeDisabled: 8,
      handleSizeActive: 12,
      handleColorZero: primary3Color,
      ...
      rippleColor: NORMAL_CONTROL.color,
    },
    snackbar: {
      textColor: alternateTextColor,
    ...
    toggle: {
      ...
      trackOffColor: '#AFAFAF',
      trackOnColor: lighten(ACTIVATED_CONTROL.color, 0.75),
      trackDisabledColor: lighten('#AFAFAF', 0.75),
      thumbOffColor: lighten('#AFAFAF', 0.75),
      thumbOnColor: ACTIVATED_CONTROL.color,
      thumbDisabledColor: 'rgba(235, 235, 235, 0.1)',
    },
    toolbar: {
      color: fade(textColor, 0.54),
